<?php
    $page_title="Movie Promote";
    include("includes/header.php");
    require("includes/lb_helper.php");
    require("language/language.php");
    
    if(isset($_POST['data_search'])){
        $qry="SELECT * FROM tbl_video_list                   
        WHERE tbl_video_list.name like '%".addslashes($_POST['search_value'])."%'
        ORDER BY tbl_video_list.category_name";
        $result=mysqli_query($mysqli,$qry); 
    
    }else{
    
        $tableName="tbl_video_list";   
        $targetpage = "manage_movie.php"; 
        $limit = 12; 
        ...
        $qry="SELECT * FROM tbl_video_list
        ORDER BY tbl_video_list.id DESC LIMIT $start, $limit";
        $result=mysqli_query($mysqli,$qry); 
    } 
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 m-auto p-auto">
                            <div class="search_list m-auto p-auto">
                                ...
                                <div class="add_btn_primary"> <a href="add_movie.php?add=yes">Add Promote</a> </div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-3 col-sm-6 col-xs-12">
                        <div class="block_wallpaper hover14">    
                            <div class="wall_image_title">
                                <h3 style="color: #ffffff; font-size: 1.30rem;"><?php echo $row['video_title'];?></h3>
                                <ul>       
                                    <li>
                                        <a href="add_movie.php?movie_id=<?php echo $row['id'];?>" class=" bs-tooltip" target="_blank"  data-placement="top" title="Edit"><i class="fa fa-edit"></i></a>
                                    </li>          
                                    <li>
                            ...
                            <?php if($row['video_image'] == ""){?>
                                <span><img src="assets/images/300x300.jpg" /></span>
                            <?php }else{?>
                                <span><img src="images/<?php echo $row['video_image'];?>" /></span>
                            <?php }?>
                        </div>
                    </div>
                    <?php
