                    ...
                    <div class="col-lg-3 col-sm-6 col-xs-12">
                        <div class="block_wallpaper hover14">           
                            <div class="wall_image_title">
                                <h3 style="color: #ffffff; font-size: 1.30rem;"><?php echo $row['album_name'];?></3>
                                <ul>                
                                    <li>
                                        <a href="add_album.php?album_id=<?php echo $row['aid'];?>" class=" bs-tooltip" target="_blank"  data-placement="top" title="Edit"><i class="fa fa-edit"></i></a>
                                    </li>               
                                    <li>
                                        <a href="" class="btn_delete_a bs-tooltip" data-id="<?php echo $row['aid'];?>" data-placement="top" title="Delete"><i class="fa fa-trash"></i></a>
                                    </li>
                                    <?php if($row['status']!="0"){?>
                                        <li><div class="row toggle_btn"><a href="javascript:void(0)" data-id="<?php echo $row['aid'];?>" data-action="deactive" data-column="status" class=" bs-tooltip" data-placement="top"  title="ENABLE"><img src="assets/images/btn_enabled.png" alt="" /></a></div></li>
                                    <?php }else{?>
                                        <li><div class="row toggle_btn"><a href="javascript:void(0)" data-id="<?php echo $row['aid'];?>" data-action="active" data-column="status" class=" bs-tooltip" data-placement="top"  title="ENABLE"><img src="assets/images/btn_disabled.png" alt="" /></a></div></li>
                                    <?php }?>
                                </ul>
                            </div>
